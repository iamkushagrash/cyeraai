...
<head>
    ...
    <title>Cyera AI | Forgot Password</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="portal-card">
                <div class="card-header">
                    ...
                    <p class="card-subtitle">>_ Please enter your UserID to reset password</p>
                </div>
               ...
               @endif
                ...
                <div class="form-container">
                	...
                	<br>
                    <!-- Login Form -->
                    <form id="msg_validate" action="{{ route('password.email') }}" method="POST" class="form active">
                    	@csrf
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="email" type="text" id="email" class="form-input @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Enter User ID">
