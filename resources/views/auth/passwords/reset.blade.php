...
<head>
    ...
    <title>Cyera AI | Reset Password</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="portal-card">
                <div class="card-header">
                    ...
                    <p class="card-subtitle">>_ Please enter new password</p>
                </div>
               ...
               @endif
                ...
                <div class="form-container">
                    ...
                    <br>
                    <!-- Login Form -->
                    <form id="msg_validate" action="{{ route('password.update') }}" method="POST" class="form active">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="password" type="password" id="password" class="form-input password-input @error('password') is-invalid @enderror" required="" value="" autocomplete="new-password" placeholder="Enter New Password">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <i class="fas fa-key input-icon"></i>
                                <input type="password" id="password-confirm" class="form-input password-input @error('password') is-invalid @enderror" name="password_confirmation" required autocomplete="new-password" placeholder="Repeat password" >
                        ...
                        <div class="form-footer">
                            <button type="submit" class="submit-btn" id="loginBtn" onclick="this.disabled=true;this.value='Processing, please wait...';this.form.submit();">
                            ...
                            <div class="form-links">
                                <a href="/login" class="form-link">
                                    <i class="fas fa-user-plus"></i> Have an account?
                                </a>
                            </div>
                        </div>
                    </form>
