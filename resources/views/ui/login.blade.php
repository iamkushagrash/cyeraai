...
<head>
    ...
    <title>Cyera AI | Web3 Portal</title>
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="content-wrapper">
            ...
            <div class="portal-card">
                <div class="card-header">
                    ...
                    <p class="card-subtitle">>_ Register a new membership or login to your account</p>
                </div>
                ...
                <div class="form-container">
                    ...
                    <form id="registerForm" class="form active">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-input" placeholder="Enter Sponsor ID" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-input" placeholder="Enter Sponsor Name" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-input phone-input" placeholder="Enter Mobile Number" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-input password-input" placeholder="Create Password" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <i class="fas fa-key input-icon"></i>
                                <input type="password" class="form-input confirm-password-input" placeholder="Confirm Password" required>
                                <button type="button" class="password-toggle">
                                    <i class="fas fa-eye"></i>
                                </button>
                            </div>
                        ...
                        <div class="form-footer">
                            ...
                            <div class="form-links">
                                <a href="#" class="form-link" id="switchToLogin">
                    ...
                    <form id="loginForm" class="form">
                        <div class="form-group">
                            <label class="form-label">
                                <i class="fas fa-user"></i>
                                USER ID / EMAIL <span>*</span>
                            </label>
                            <div class="input-group">
                                <i class="fas fa-user-circle input-icon"></i>
                                <input type="text" class="form-input" placeholder="Enter User ID or Email" required>
                            </div>
                        </div>
                        ...
                        <div class="form-footer">
                            ...
                            <div class="form-links">
                                <a href="#" class="form-link" id="switchToRegister">
        ...
        <footer class="portal-footer">
            <p>>_ © 2026 Cyera AI. Web3 MLM Platform</p>
    ...
    <script>
        ...
        function switchTab(tabName) {
            ...
            // Show message
            showMessage(`${tabName === 'login' ? 'LOGIN' : 'REGISTRATION'} FORM ACTIVATED`, 'success');
        }
        ...
        document.getElementById('registerForm').addEventListener('submit', async function(e) {
            ...
            showMessage('REGISTRATION SUCCESSFUL! WELCOME TO METAFORCE.', 'success');
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            setTimeout(() => {
                showMessage('WELCOME TO METAFORCE WEB3 PORTAL', 'success');
            }, 1000);
        });
    </script>
</body>
