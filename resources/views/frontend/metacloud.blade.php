...
{{-- ✅ Page Title --}}
@section('title', 'Cyera Cloud - Decentralized Web3 Cloud Storage')

{{-- ✅ SEO Meta Tags --}}
@section('meta_description', 'Cyera Cloud is a blockchain-powered decentralized storage solution that lets you store, share, and access your files securely without relying on centralized servers.')
@section('meta_keywords', 'Cyera Cloud, decentralized storage, Web3 cloud, blockchain storage, secure file sharing, crypto storage, distributed cloud, Cyera AI')

{{-- ✅ Open Graph (for Facebook/LinkedIn) --}}
@section('og_title', 'Cyera Cloud - Secure & Decentralized Web3 Cloud Storage')
@section('og_description', 'Take control of your data with Cyera Cloud – a decentralized storage platform that gives you privacy, ownership, and accessibility without middlemen.')

{{-- ✅ Twitter Card --}}
@section('twitter_title', 'Cyera Cloud - Secure & Decentralized Storage')
@section('twitter_description', 'Store and share your files with full privacy. Cyera Cloud is a blockchain-based decentralized cloud designed for freedom and security.')
      ...
      <div class="container">
        <div class="inner-banner-typography">
          <div class="inner-banner-subtitle-wrap">
                                <div class="inner-banner-subtitle">About Cyera Cloud</div>
                            </div>
          <div class="inner-banner-title-wrapper">
              <h1 class="inner-banner-title about-us">
                                    Cyera Cloud – Decentralized, Secure, & Web3 Storage
                                </h1>
                                <p class="inner-banner-description about-us">
                                    Cyera Cloud is a Web3-based decentralized storage platform where users can securely store, access, and share data without relying on centralized servers.  
                                    Using blockchain verification and encryption, Cyera Cloud ensures your files are private, tamper-proof, and globally accessible anytime, anywhere.
                                </p>
    ...
    <section class="section about-us-gallery">
        <div class="about-us-gallery-container">
            <div data-w-id="b5b2be2c-67e6-7ba9-6d32-f33422506a58" style="opacity:0" class="about-us-gallery-wrapper">
                <div class="about-us-gallery-image-wrapper"><img src="{{ asset('main/assets/images/metastoragebanner1.png') }}" loading="lazy" alt="" class="about-us-gallery-image left" /><img src="{{ asset('main/assets/images/cyeracloudbanner2.png') }}"
                    loading="lazy" sizes="(max-width: 840px) 100vw, 840px" srcset="{{ asset('main/assets/images/cyeracloudbanner2.png') }} 500w, {{ asset('main/assets/images/cyeracloudbanner2.png') }} 800w, {{ asset('main/assets/images/cyeracloudbanner2.png') }} 840w"
                    alt="" class="about-us-gallery-image middle" /><img src="{{ asset('main/assets/images/metastoragebanner1.png') }}" loading="lazy" alt="" class="about-us-gallery-image right"
                    /></div>
               <div class="about-us-gallery-description-wrapper">
       <p class="about-us-gallery-description-text">
                            Cyera Cloud offers a decentralized, trustless storage experience — giving users full control over their files, encrypted access, and secure sharing powered by Web3 technologies.
                        </p>
                    ...
                    <div class="history-wrapper">
                        <div class="histories-flex-wrap">
                            ...
                            <div class="single-history-wrap">
                                <div class="split-wrapper">
                                    <div class="history-image-wrap">
                                        <img sizes="100vw" src="{{ asset('main/assets/images/cyeracloud1.png') }}" alt="Cyera Cloud Dashboard" loading="lazy" class="history-image" />
                                    </div>
                                </div>
                                <div class="split-wrapper">
                                    <div class="history-content-wrap">
                                        ...
                                        <div class="history-details-wrap">
                                            ...
                                            <p class="history-details">
                                                Manage all your files, storage quotas, and shared folders in one decentralized, blockchain-secured dashboard.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single-history-wrap reverse">
                                <div class="split-wrapper">
                                    <div class="history-content-wrap align-right">
                                        <div class="history-year">(Files)</div>
                                        <div class="history-details-wrap">
                                            <h2 class="history-title">File Upload & Sharing</h2>
                                            <p class="history-details">
                                                Upload, download, and share files securely with blockchain verification — ensuring integrity, privacy, and access control.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="split-wrapper">
                                    <div class="history-image-wrap">
                                        <img sizes="100vw" src="{{ asset('main/assets/images/cyeracloud2.png') }}" alt="Cyera Cloud Files" loading="lazy" class="history-image" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-history-wrap">
                                <div class="split-wrapper">
                                    <div class="history-image-wrap">
                                        <img sizes="100vw" src="{{ asset('main/assets/images/cyeracloud3.png') }}" alt="Cyera Cloud Security" loading="lazy" class="history-image" />
                                    </div>
                                </div>
                                <div class="split-wrapper">
                                    <div class="history-content-wrap">
                                        ...
                                        <div class="history-details-wrap">
                                            ...
                                            <p class="history-details">
                                                Files are encrypted end-to-end and stored across a decentralized network — no central server, complete privacy, and tamper-proof data.
                                            </p>
                                        </div>
                                    </div>
                                </div>
