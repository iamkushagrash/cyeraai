...
{{-- ✅ Page Title --}}
@section('title', 'Meta Meet - Decentralized Virtual Meetings & Collaboration')

{{-- ✅ SEO Meta Tags --}}
@section('meta_description', 'Meta Meet is a decentralized video conferencing and collaboration platform powered by blockchain. Enjoy secure, private, and borderless virtual meetings for businesses, communities, and teams.')
@section('meta_keywords', 'Meta Meet, decentralized meetings, blockchain conferencing, secure video calls, private meetings, virtual collaboration, Web3 communication, encrypted video chat')

{{-- ✅ Open Graph (for Facebook/LinkedIn) --}}
@section('og_title', 'Meta Meet - Decentralized Virtual Meetings & Collaboration')
@section('og_description', 'Host secure, borderless, and blockchain-powered video meetings with Meta Meet. Experience true privacy, collaboration, and next-generation Web3 communication.')

{{-- ✅ Twitter Card --}}
@section('twitter_title', 'Meta Meet - Decentralized Virtual Meetings & Collaboration')
@section('twitter_description', 'Meta Meet brings you secure, encrypted, and borderless video conferencing powered by blockchain technology.')
      ...
      <div class="container">
        <div class="inner-banner-typography">
          <div class="inner-banner-subtitle-wrap">
            <div class="inner-banner-subtitle">About Meta Meet</div>
          </div>
          <div class="inner-banner-title-wrapper">
           <h1 class="inner-banner-title about-us">
                                    Meta Meet – Decentralized, Secure, & Web3 Powered
                                </h1>
           <p class="inner-banner-description about-us">
                                    Meta Meet is a Web3-based decentralized meeting platform where users can create,
                                    join, and manage meetings without centralized servers.  
                                    With end-to-end encryption, blockchain verification, and seamless connectivity, Meta Meet ensures secure, transparent, and trustless communication for businesses and communities worldwide.
                                </p>
    ...
    <section class="section about-us-gallery">
        <div class="about-us-gallery-container">
            <div data-w-id="b5b2be2c-67e6-7ba9-6d32-f33422506a58" style="opacity:0" class="about-us-gallery-wrapper">
                <div class="about-us-gallery-image-wrapper"><img src="{{ asset('main/assets/images/metameetbanner1.png') }}" loading="lazy" alt="" class="about-us-gallery-image left" /><img src="{{ asset('main/assets/images/metameetbanner2.png') }}"
                    loading="lazy" sizes="(max-width: 840px) 100vw, 840px" srcset="{{ asset('main/assets/images/metameetbanner2.png') }} 500w, {{ asset('main/assets/images/metameetbanner2.png') }} 800w, {{ asset('main/assets/images/metameetbanner2.png') }} 840w"
                    alt="" class="about-us-gallery-image middle" /><img src="{{ asset('main/assets/images/metameetbanner1.png') }}" loading="lazy" alt="" class="about-us-gallery-image right"
                    /></div>
               <div class="about-us-gallery-description-wrapper">
    <p class="about-us-gallery-description-text">
                            Meta Meet provides a secure, decentralized platform for hosting and joining meetings — empowering users with transparent, blockchain-verified interactions and private, trustless communication channels.
                        </p>
                    ...
                    <div class="history-wrapper">
                        <div class="histories-flex-wrap">
                            ...
                            <div class="single-history-wrap">
                                <div class="split-wrapper">
                                    <div class="history-image-wrap">
                                        <img sizes="100vw" src="{{ asset('main/assets/images/metameet1.png') }}" alt="Meta Meet Dashboard" loading="lazy" class="history-image" />
                                    </div>
                                </div>
                                <div class="split-wrapper">
                                    <div class="history-content-wrap">
                                        ...
                                        <div class="history-details-wrap">
                                            ...
                                            <p class="history-details">
                                                Overview of your meetings — upcoming, ongoing, and past sessions, along with participant info and meeting settings.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single-history-wrap reverse">
                                <div class="split-wrapper">
                                    <div class="history-content-wrap align-right">
                                        <div class="history-year">(Meetings)</div>
                                        <div class="history-details-wrap">
                                            <h2 class="history-title">Create & Join Meetings</h2>
                                            <p class="history-details">
                                                Easily create or join decentralized meetings using blockchain-verified links.  
                                                End-to-end encryption ensures privacy and trustless connectivity.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="split-wrapper">
                                    <div class="history-image-wrap">
                                        <img sizes="100vw" src="{{ asset('main/assets/images/metameet2.png') }}" alt="Meta Meet Meetings" loading="lazy" class="history-image" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-history-wrap">
                                <div class="split-wrapper">
                                    <div class="history-image-wrap">
                                        <img sizes="100vw" src="{{ asset('main/assets/images/metameet3.png') }}" alt="Meta Meet Interaction Details" loading="lazy" class="history-image" />
                                    </div>
                                </div>
                                <div class="split-wrapper">
                                    <div class="history-content-wrap">
                                        <div class="history-year">(Details)</div>
                                        <div class="history-details-wrap">
                                            <h2 class="history-title">Interaction Details</h2>
                                            <p class="history-details">
                                                Access meeting history, participant attendance, blockchain verification, and meeting recordings — all securely logged on-chain.
                                            </p>
                                        </div>
                                    </div>
                                </div>
