...
{{-- ✅ Page Title --}}
@section('title', 'Meta Play - Decentralized Web Gaming Platform')

{{-- ✅ SEO Meta Tags --}}
@section('meta_description', 'Meta Play is a decentralized Web3-based gaming platform where players can enjoy immersive games, earn rewards, and trade in-game assets securely on the blockchain.')
@section('meta_keywords', 'Meta Play, decentralized gaming, blockchain gaming, play-to-earn, Web3 games, NFT gaming, crypto rewards, metaverse gaming, online games, web-based gaming')

{{-- ✅ Open Graph (for Facebook/LinkedIn) --}}
@section('og_title', 'Meta Play - Decentralized Web Gaming Platform')
@section('og_description', 'Discover Meta Play, a blockchain-powered gaming hub. Play web-based games, earn crypto rewards, and own your digital assets in a decentralized ecosystem.')

{{-- ✅ Twitter Card --}}
@section('twitter_title', 'Meta Play - Decentralized Web Gaming Platform')
@section('twitter_description', 'Meta Play lets you play, earn, and trade in the Web3 gaming world. True ownership, blockchain rewards, and immersive online games.')
      ...
      <div class="container">
        <div class="inner-banner-typography">
          <div class="inner-banner-subtitle-wrap">
            <div class="inner-banner-subtitle">About Meta Play</div>
          </div>
          <div class="inner-banner-title-wrapper">
            <h1 class="inner-banner-title about-us">
                                    Meta Play – Decentralized Gaming, Powered by Web3
                                </h1>
           <p class="inner-banner-description about-us">
                                    Meta Play is a Web3-based decentralized gaming platform where users can enjoy
                                    a wide variety of games without centralized control.  
                                    With blockchain verification, secure asset ownership, and transparent reward mechanisms, Meta Play offers gamers a trustless and immersive gaming experience worldwide.
                                </p>
    ...
    <section class="section about-us-gallery">
        <div class="about-us-gallery-container">
            <div data-w-id="b5b2be2c-67e6-7ba9-6d32-f33422506a58" style="opacity:0" class="about-us-gallery-wrapper">
                <div class="about-us-gallery-image-wrapper"><img src="{{ asset('main/assets/images/metaplaybanner1.png') }}" loading="lazy" alt="" class="about-us-gallery-image left" /><img src="{{ asset('main/assets/images/metaplaybanner2.png') }}"
                    loading="lazy" sizes="(max-width: 840px) 100vw, 840px" srcset="{{ asset('main/assets/images/metaplaybanner2.png') }} 500w, {{ asset('main/assets/images/metaplaybanner2.png') }} 800w, {{ asset('main/assets/images/metaplaybanner2.png') }} 840w"
                    alt="" class="about-us-gallery-image middle" /><img src="{{ asset('main/assets/images/metaplaybanner1.png') }}" loading="lazy" alt="" class="about-us-gallery-image right"
                    /></div>
                            ...
                            <div class="single-history-wrap">
                                <div class="split-wrapper">
                                    <div class="history-image-wrap">
                                        <img sizes="100vw" src="{{ asset('main/assets/images/metaplay1.png') }}" alt="Meta Play Dashboard" loading="lazy" class="history-image" />
                                    </div>
                                </div>
                                <div class="split-wrapper">
                                    <div class="history-content-wrap">
                                        ...
                                        <div class="history-details-wrap">
                                            <h2 class="history-title">Gaming Dashboard</h2>
                                            <p class="history-details">
                                                Overview of your games, in-game assets, achievements, and active sessions — all in one secure decentralized dashboard.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single-history-wrap reverse">
                                <div class="split-wrapper">
                                    <div class="history-content-wrap align-right">
                                        <div class="history-year">(Games)</div>
                                        <div class="history-details-wrap">
                                            <h2 class="history-title">Game Library</h2>
                                            <p class="history-details">
                                                Explore different kinds of games — strategy, action, puzzles, and more — all hosted on a decentralized, blockchain-verified platform.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="split-wrapper">
                                    <div class="history-image-wrap">
                                        <img sizes="100vw" src="{{ asset('main/assets/images/metaplay2.png') }}" alt="Meta Play Games" loading="lazy" class="history-image" />
                                    </div>
                                </div>
                            </div>

                            <!-- Rewards & Interaction UI -->
                            <div class="single-history-wrap">
                                <div class="split-wrapper">
                                    <div class="history-image-wrap">
                                        <img sizes="100vw" src="{{ asset('main/assets/images/metaplay3.png') }}" alt="Meta Play Rewards" loading="lazy" class="history-image" />
                                    </div>
                                </div>
                                <div class="split-wrapper">
                                    <div class="history-content-wrap">
                                        <div class="history-year">(Rewards)</div>
                                        <div class="history-details-wrap">
                                            <h2 class="history-title">Rewards & Interactions</h2>
                                            <p class="history-details">
                                                Track in-game rewards, trade assets, and interact with other players — all securely recorded on-chain for transparency and fairness.
                                            </p>
                                        </div>
                                    </div>
                                </div>
