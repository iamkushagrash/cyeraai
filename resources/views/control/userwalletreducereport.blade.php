...
<head>
    ...
    <title>Admin Reduce Report</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Admin Wallet Reduce Report</h1>
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>Admin Wallet Reduce Report</strong>
                                </li>
                            </ol>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/UserWalletReduceReport" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Admin Wallet Reduce Report</h2>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    @foreach($reduce as $reduce)
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$reduce->userid}}</td>
                                                        <td>{{$reduce->email}}</td>
                                                        <td>{{$reduce->usersname}}</td>
                                                        <td>{{round($reduce->amount,2)}}</td>
                                                        <td>{{$reduce->created_at}}</td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
