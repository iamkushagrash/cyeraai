...
<head>
    ...
    <title>Search User Teamwise Club Income</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">User Teamwise Club Income</h1>
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>User Teamwise Club Income</strong>
                                </li>
                            </ol>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/UserSearchforTeamClubIncome" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">User Teamwise Club Income (Total Amount ($): {{ round($totalAmount, 2) }})</h2>
