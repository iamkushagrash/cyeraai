...
<head>
    ...
    <title>Admin Income Reduce</title>
...
@include('control.sidebaradmin')
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Admin Reduce Income of User</h1>
                    ...
                    <section class="box has-border-left-3">
                            <div class="content-body">    
                                <div class="row">
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <i class="fa"></i>
                                                                <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" value="" placeholder="UserID" required="" >
                                                                @error('email')
                                    ...
                                    <div class="form-container">
                                        <header class="panel_header">
                                                <h2 class="title pull-left">Available Balance : {{floor($income->remainingIncome())}} $</h2>
                                            </header>
                                        <form action="/Main/ReduceUserIncomeByAdmin" method="post" id="detail">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <!-- <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Amount (CAI)</label>
                                                           
                                                            <div class="controls">
                                                                <i class=""></i>
                                                                <input type="number" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror" value=""placeholder="Amount CAI" max="{{floor($income->remainingIncome())}}" step="0.01">
                                                                @error('amount')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <span class="desc"><!-- "Minimum 50 " --></span>
                                                            <div class="controls">
                                                                <i class=""></i>
                                                                <input type="number" name="amountusdt" id="amountusdt" class="form-control @error('amountusdt') is-invalid @enderror" value=""placeholder="Amount USDT" required="" step="0.01">
                                                                @error('amount')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
    ...
    <script type="text/javascript">
        ...
        /*$("#amount").on('blur',function(){
            $("#amountusdt").val(Number.parseFloat($("#amount").val()*{{$price}}).toFixed(6));
        });
        $("#amountusdt").on('blur',function(){
            $("#amount").val(Number.parseFloat($("#amountusdt").val()/{{$price}}).toFixed(6));
        });*/
    </script>
