                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Topup Report</h1>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/UserPackageHistory" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-xs-12">
                    <section class="box over-h">
                        <div class="content-body">    
                            <div class="row">
                                <div class="col-xs-12">
                                    <h4>Total Stake : {{round($sumamount->amountusdt,2)}}$ ( {{round($sumamount->amountstake,2)}} CAI) </h4>
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Topup Report</h2>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    @foreach($basichistory as $basichistory)
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$basichistory->uuid}}</td>
                                                        <td>{{$basichistory->usersname}}</td>
                                                        <td>{{round($basichistory->usdt,2)}}</td>
                                                        <td>{{round($basichistory->amount,2)}}</td>
                                                        <td>{{$basichistory->cps}} % PD</td>
                                                        <td>{{$basichistory->fromname}} ({{$basichistory->fromid}})</td>
                                                        <td>{{$basichistory->staketype}}</td>
                                                        <td>{{$basichistory->created_at}}</td>
                                                        <td><span class="{{$basichistory->statusclass}}">{{$basichistory->status}}</span></td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
