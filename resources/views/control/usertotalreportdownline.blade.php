...
<head>
    ...
    <title>Search User Team Report</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Search Team Report</h1>
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>User Team Report</strong>
                                </li>
                            </ol>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/UserSearchforTotalReport" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">User Team Report</h2>
                                        ...
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:left;">Total Investment($)</th>
                                                    ...
                                                    <th style="text-align:left;">Staking Income($)</th>
                                                    <th style="text-align:left;">Direct Income($)</th>
                                                    <th style="text-align:left;">Staking Referral($)</th>
                                                    <th style="text-align:left;">Club Income($)</th>
                                                    <th style="text-align:left;">Lifetime Income($)</th>
                                                    <th style="text-align:left;">Total Income($)</th>
                                                    <th style="text-align:left;">Total WIthdrawal($)</th>
                                            </thead>
                                            <tbody>
                                                <?php $i=1; ?>
                                                    ...
                                                    <tr style="color: #fff;">
                                                        ...
                                                        <td>{{round($data->product,2)}}</td>
                                                        <td>{{round($data->wallet,2)}}</td>
                                                        <td>{{round($data->loan,2)}}</td>
                                                        <td>{{round($data->gold,2)}}</td>
                                                        <td>{{round($data->silver,2)}}</td>
                                                        <td>{{round($data->staking_income,2)}}</td>
                                                        <td>{{round($data->direct_income,2)}}</td>
                                                        <td>{{round($data->staking_referral_income,2)}}</td>
                                                        <td>{{round($data->club_income,2)}}</td>
                                                        <td>{{round($data->lifetime_income,2)}}</td>
                                                        <td>{{round($data->total_income,2)}}</td>
                                                        <td>{{round($data->total_withdrawal,2)}}</td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
