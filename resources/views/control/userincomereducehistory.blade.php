...
<head>
    ...
    <title>User Income Reduce History</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Income Reduce History</h1>
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>Income Reduce History</strong>
                                </li>
                            </ol>
                        </div>
                ...
                <div class="col-xs-12">
                    <section class="box over-h">
                        <div class="content-body">    
                            <div class="row">
                                <div class="col-xs-12">
                                    <h4>Total Reduce : {{round($sumtotal->amountusdt,2)}}$</h4>
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Income Reduce History</h2>
                            @if (session('success'))
