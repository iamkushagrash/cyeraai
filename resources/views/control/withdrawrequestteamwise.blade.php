...
<head>
    ...
    <title>Search Team Wise Withdrawal Request</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Team Wise Withdrawal Request</h1>
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>Team Wise Withdrawal Request</strong>
                                </li>
                            </ol>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/UserSearchforTeamWithdrawalRequest" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Team Withdrawal Requests (Total Pending ($): {{ round($totalAmount, 2) }})</h2>
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    ...
                                                    <tr style="color: #fff;">
                                                        ...
                                                        <td>{{round($data->deduction,2)}}</td>
                                                        <td>{{round($data->net_amount,2)}}</td>
                                                        <td>{{$data->currency}}</td>
                                                        <td>{{$data->withdrawtype}}</td>
                                                        <td>{{$data->txndate}}</td>
                                                        <td><span class="{{$data->statusclass}}">{{$data->status}}</span></td>
                                                        <td><a href="/Main/WithdrawApprove/{{$data->txnid}}" class="text-danger" data-bs-toggle="tooltip" data-bs-original-title="Edit" target="_blank" style="color:#fff;"><i class="ti-pencil" aria-hidden="true"></i>Approve</a></td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
