...
<head>
    ...
    <title>User Silver Report</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Silver Report</h1>
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Silver Report</h2>
                                        ...
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:left;">Ready Income ($)</th>
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    ...
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$silver->uuid}}</td>
                                                        <td>{{$silver->usersname}}</td>
                                                        <td>{{round($silver->usdt,2)}}</td>
                                                        <td>{{round($silver->userDetail()->totalWithdraw()->sum('amountusdt'),2)}}</td>
                                                        <td>{{round($silver->userDetail()->remainingIncome(),2)}}</td>
                                                        <td>{{$silver->created_at}}</td>
                                                        <td><span class="{{$silver->statusclass}}">{{$silver->status}}</span></td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
