...
<head>
    ...
    <title>Lifetime Power Leg Members</title>
                    ...
                    <div class="page-title">
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>Lifetime Power Leg Members</strong>
                                </li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Lifetime Power Leg Members</h2>
                                        ...
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    ...
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td><a href="/Main/User/{{$members->userid}}" style="color: #fff;">{{$members->userid}}</a></td>
                                                        <td>{{$members->email}}</td>
                                                        <td>{{$members->name}}</td>
                                                        <td>{{$members->guiderid}}</td>
                                                        <td>{{$members->doj}}</td>
                                                        <td>{{round($members->current,2)}}</td>
                                                        <!-- <td>{{$members->leveluser}} %</td> -->
