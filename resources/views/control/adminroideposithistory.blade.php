...
<head>
    ...
    <title>Admin Silver(ROI) Topup Report</title>
                    ...
                    <div class="page-title">
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>Admin Silver(ROI) Topup Report</strong>
                                </li>
                            </ol>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/AdminROITopupReport" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-xs-12">
                    <section class="box over-h">
                        <div class="content-body">    
                            <div class="row">
                                <div class="col-xs-12">
                                    <h4>Total : {{round($sumamount->amountusdt,2)}}$</h4>
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Admin Silver(ROI) Topup Report</h2>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    @foreach($topup as $basichistory)
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$basichistory->userid}}</td>
                                                        <td>{{$basichistory->usersname}}</td>
                                                        <td>{{round($basichistory->amountusdt,2)}}</td>
                                                        <td>{{$basichistory->paidbyname}} ({{$basichistory->paidbyid}})</td>
