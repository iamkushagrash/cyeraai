...
<head>
    ...
    <title>Search User Silver Team</title>
                    ...
                    <div class="page-title">
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>User Silver Team</strong>
                                </li>
                            </ol>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/SearchSilverTeam" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">User Silver Team (Total Amount ($): {{ round($totalAmount, 2) }})</h2>
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    ...
                                                    <tr style="color: #fff;">
                                                        ...
                                                        <td>{{$data->doj}}</td>
                                                        <td>{{$data->level}}</td>
                                                        <td>@if($data->userDetails()->first()->levelStatus()>=$data->leveluser){{$data->userDetails()->first()->levelStatus()}}@else{{$data->leveluser}} @endif</td>
                                                        <td>{{round($data->silveramount,2)}}</td>
