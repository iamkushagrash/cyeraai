...
<head>
    ...
    <title>User Staking Income</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Staking Income Report(Product)</h1>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/StakingIncomeReportProduct" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Staking Income Report(Product)</h2>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    @foreach($reportbasic as $reportbasic)
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$reportbasic->userid}}</td>
                                                        <td>{{$reportbasic->name}}</td>
                                                        <td>{{round($reportbasic->amount,2)}}</td>
                                                        <td>{{round($reportbasic->amountusdt,2)}}</td>
                                                        <td>{{round($reportbasic->principal,3)}}</td>
