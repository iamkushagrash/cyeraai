...
<head>
    ...
    <title>MetaWallet USDT Deposit</title>
                    ...
                    <div class="page-title">
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>MetaWallet Depoit</strong>
                                </li>
                            </ol>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/UserMetaWalletDeposit" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-xs-12">
                    <section class="box over-h">
                        <div class="content-body">    
                            <div class="row">
                                <div class="col-xs-12">
                                    <h4>Total Deposit : {{round($sumamount->amountusdt,2)}}$  </h4>
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">MetaWallet USDT Deposit Report</h2>
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    ...
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$topup->userid}}</td>
                                                        <td>{{$topup->usersname}}</td>
                                                        <td>{{round($topup->amountusdt,2)}}</td>
                                                        <td>{{$topup->created_at}}</td>
                                                        <td><span class="{{$topup->statusclass}}">{{$topup->status}}</span></td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
