...
<head>
    ...
    <title>Search User Ready Income and Withdrawal</title>
                    ...
                    <div class="page-title">
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>User Ready Income and Withdrawal</strong>
                                </li>
                            </ol>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/SearchUserforReadyWithdrawal" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">User Ready Income and Withdrawal</h2>
                                        ...
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:left;">Withdraw ($)</th>
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    ...
                                                    <tr style="color: #fff;">
                                                        ...
                                                        <td>{{$data->name}}</td>
                                                        <td>{{$data->level}}</td>
                                                        <!-- <td>{{round($data->userDetails()->first()->remainingIncome(),2)}}</td> -->
                                                        <td>{{round($data->userDetails()->first()->totalWithdraw()->sum('amountusdt'),2)}}</td>
