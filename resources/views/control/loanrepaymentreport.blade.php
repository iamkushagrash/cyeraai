...
<head>
    ...
    <title>User Loan Repayment Report</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Loan Repayment Report</h1>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/LoanRepaymentHistory" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Loan Repayment Report</h2>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    @foreach($loanreport as $loanreport)
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$loanreport->userid}}</td>
                                                        <td>{{$loanreport->name}}</td>
                                                        <td>{{round($loanreport->amount,2)}}</td>
                                                        <td>{{round($loanreport->loan,2)}}</td>
                                                        <td>{{round($loanreport->remaining,3)}}</td>
                                                        <td>{{$loanreport->status}}</td>
                                                        <td>{{$loanreport->created_at}}</td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
