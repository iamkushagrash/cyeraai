...
<head>
    ...
    <title>Staking Referral Income</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Staking Referral Report</h1>
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>Staking Referral</strong>
                                </li>
                            </ol>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/StakingReferralIncome" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-xs-12">
                    <section class="box over-h">
                        <div class="content-body">    
                            <div class="row">
                                <div class="col-xs-12">
                                    <h4>Total : {{round($sumamount->amountusdt,2)}}$ ( {{round($sumamount->amountcoin,2)}} CAI) </h4>
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Staking Referral Report</h2>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    @foreach($reportlevel as $reportlevel)
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$reportlevel->userid}}</td>
                                                        <td>{{$reportlevel->name}}</td>
                                                        <td>{{round($reportlevel->amount,2)}}</td>
                                                        <td>{{round($reportlevel->amountusdt,2)}}</td>
                                                        <td>{{$reportlevel->created_at}}</td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
