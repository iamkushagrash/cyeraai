                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Admin Loan Remove to User</h1>
                    ...
                    <section class="box has-border-left-3">
                            ...
                            <div class="content-body">    
                                <div class="row">
                                    ...
                                    @else
                                    <div class="form-container">
                                        <form action="/Main/AdminLoanRemoveToUser" method="post" id="detail">
                                            @csrf
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <input type="number" name="amount" class="form-control @error('amount') is-invalid @enderror" value="{{$loanamount}}" placeholder="USD Quantity"  required="" readonly >
                                                                @error('amount')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
