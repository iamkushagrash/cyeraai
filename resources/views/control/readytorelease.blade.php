                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Ready to Release Income</h2>
                                        ...
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <!-- <th style="text-align:left;">Active Direct</th> -->
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    ...
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td><a href="/Main/UserOneClick/{{$members->userid}}" style="color: #fff;">{{$members->userid}}</a></td>
                                                        <td><a href="/Main/UserOneClick/{{$members->userid}}" style="color: #fff;">{{$members->email}}</a></td>
                                                        <td>{{$members->name}}</td>
                                                        <td>{{$members->guiderid}}</td>
                                                        <td>{{$members->doj}}</td>
                                                        <td>{{round($members->current)}}</td>
                                                        <td>{{round($members->userDetails()->first()->remainingIncome(),2)}}</td>
                                                        <!-- <td>{{$members->activedirect}}</td> -->
                                                        <!-- <td><span class="{{$members->statusclass}}">{{$members->status}}</span></td> -->
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
