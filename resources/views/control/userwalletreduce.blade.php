                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Admin Reduce Wallet of User</h1>
                    ...
                    <section class="box has-border-left-3">
                            <div class="content-body">    
                                <div class="row">
                                    ...
                                    <div class="form-container">
                                        <header class="panel_header">
                                                <h2 class="title pull-left">Available Balance : {{\Illuminate\Support\Facades\Crypt::decrypt($balance->amount)}} $</h2>
                                            </header>
                                        <form action="/Main/ReduceUserWalletByAdmin" method="post" id="detail">
                                            @csrf
                                                ...
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <i class=""></i>
                                                                <input type="number" name="amount" class="form-control @error('amount') is-invalid @enderror" value=""placeholder="Amount"  required="" step="0.01">
                                                                @error('amount')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
