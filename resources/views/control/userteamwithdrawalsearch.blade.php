...
<head>
    ...
    <title>Search Team Withdrawal</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Team Withdrawal</h1>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/UserSearchforTeamWithdrawal" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
