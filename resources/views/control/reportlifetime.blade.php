...
<head>
    ...
    <title>User Lifetime Reward</title>
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Lifetime Reward Report</h1>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/LifetimeReward" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Lifetime Reward Report</h2>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    @foreach($reportlifetime as $reportlifetime)
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$reportlifetime->userid}}</td>
                                                        <td>{{$reportlifetime->name}}</td>
                                                        <td>{{round($reportlifetime->amount,2)}}</td>
                                                        <td>{{$reportlifetime->rewardname}}</td>
                                                        <td>{{$reportlifetime->created_at}}</td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
