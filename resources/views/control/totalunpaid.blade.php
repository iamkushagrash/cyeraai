                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Unpaid Members</h2>
                                        ...
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:left;">Team Shares($)</th>
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    ...
                                                    <tr style="color: #fff;">
                                                        ...
                                                        <td>{{$members->name}}</td>
                                                        <td>{{$members->doj}}</td>
                                                        <td>{{round($members->totalinvestment,2)}}</td>
