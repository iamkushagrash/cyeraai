                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Club Income Report</h1>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        <form action="/Main/ClubIncome" method="POST">
                                        @csrf
                                           <div class="col-lg-3">
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">Club Income Report</h2>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; ?>
                                                    @foreach($reportclub as $reportclub)
                                                    <tr style="color: #fff;">
                                                        <td>{{$i}}</td>
                                                        <td>{{$reportclub->userid}}</td>
                                                        <td>{{$reportclub->name}}</td>
                                                        <td>{{round($reportclub->amount,2)}}</td>
                                                        <td>{{$reportclub->clubname}}</td>
                                                        <td>{{round($reportclub->amountusdt,2)}}</td>
                                                        <td>{{$reportclub->created_at}}</td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    @endforeach                                         
                                            </tbody>
