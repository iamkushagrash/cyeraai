				...
				<div class="col-xl-6 col-lg-6">
					...
					<div class="card mb-3">
						...
						<div class="card-body">
                    		...
                    		<a href="https://wa.me/?text=Use%20my%20referral%20link%20to%20join%20CAI%20{{url('/').'/register/'.Session::get('user.uuid')}}" target="_blank"><i class="fab fa-lg fa-fw me-2 fa-whatsapp"></i></a>
