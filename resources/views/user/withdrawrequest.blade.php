...
@section('page-actions')
    <a href="{{ url('/User/WithdrawalHistory') }}" class="mecha-btn-outline"
        style="height: 32px; padding: 0 10px; font-size: 10px; border-color: rgba(0, 255, 136, 0.4); color: #00FF88;">
...
@section('content')
    ...
    <div class="mecha-hud-card" style="position: relative;">
        ...
        @if($t || $b || $k)
            ...
            <div
                style="background: rgba(0, 255, 136, 0.04); border: 1px solid rgba(0, 255, 136, 0.2); border-radius: 10px; padding: 10px 12px; margin-bottom: 16px; display: flex; align-items: center; justify-content: space-between; gap: 8px;">
                <div style="display: flex; align-items: center; gap: 8px; min-width: 0; flex: 1;">
                    <div
                        style="width: 32px; height: 32px; border-radius: 8px; background: rgba(0, 255, 136, 0.12); color: #00FF88; display: flex; align-items: center; justify-content: center; font-size: 13px; flex-shrink: 0;">
                        <i class="fas fa-wallet"></i>
                    </div>
                    <div style="min-width: 0; flex: 1;">
                        <div
                            style="font-size: 8.5px; color: #8C9BAE; text-transform: uppercase; font-weight: 700; letter-spacing: 0.5px;">
                            Connected Web3 Destination</div>
                        <div
                ...
                <span
                    style="display: inline-flex; align-items: center; gap: 4px; font-size: 9px; color: #00FF88; font-weight: 700; background: rgba(0,255,136,0.1); padding: 4px 8px; border-radius: 6px; border: 1px solid rgba(0,255,136,0.3); flex-shrink: 0;">
            ...
            <form action="{{ url('/User/WithdrawRequest') }}" method="POST" id="withdrawWorkingForm">
                ...
                <div class="mecha-form-group">
                    ...
                    <div class="mecha-input-wrap">
                        ...
                        <input type="number" class="mecha-input-control @error('amountusdt') is-invalid @enderror"
                        ...
                        <button type="button" class="mecha-input-suffix-btn"
                            style="border-color: rgba(0, 255, 136, 0.4); color: #00FF88;"
                            onclick="setPresetPct(100)">MAX</button>
                    </div>

                    <!-- Quick Presets -->
                    <div style="display: flex; gap: 6px; margin-top: 6px; flex-wrap: wrap;">
                        <button type="button" class="mecha-btn-outline" style="height: 28px; padding: 0 10px; font-size: 11px;"
                            onclick="setPresetPct(25)">25%</button>
                        <button type="button" class="mecha-btn-outline" style="height: 28px; padding: 0 10px; font-size: 11px;"
                            onclick="setPresetPct(50)">50%</button>
                        <button type="button" class="mecha-btn-outline" style="height: 28px; padding: 0 10px; font-size: 11px;"
                            onclick="setPresetPct(75)">75%</button>
                        <button type="button" class="mecha-btn-outline"
                            style="height: 28px; padding: 0 10px; font-size: 11px; border-color: #00FF88; color: #00FF88;"
                            onclick="setPresetPct(100)">MAX</button>
                    </div>

                    <div
                        style="font-size: 9.5px; color: #8C9BAE; margin-top: 4px; display: flex; align-items: center; gap: 4px;">
                ...
                <div class="mecha-form-group">
                    ...
                    <div class="mecha-input-wrap">
                        ...
                        <select class="mecha-select-control" id="currency" name="currency" required>
                            @if($b)
                            <option value="usdtbep20">USDT (BEP-20 / BNB Chain)</option>@endif
                            @if($t)
                            <option value="usdt">USDT (TRC-20 / Tron)</option>@endif
                            @if($k)
                            <option value="bank">Bank Wire Transfer</option>@endif
                        </select>
                    </div>
                </div>
                ...
                <div
                    style="background: rgba(3, 5, 8, 0.9); border: 1px solid rgba(0, 255, 136, 0.2); border-radius: 10px; padding: 10px 12px; margin-bottom: 16px;">
                    <div
                        style="display: flex; align-items: center; gap: 6px; font-size: 9.5px; font-weight: 800; color: #8C9BAE; letter-spacing: 0.8px; margin-bottom: 8px;">
        ...
        @else
            ...
            <div style="text-align: center; padding: 24px 12px;">
                <div
                    style="width: 50px; height: 50px; border-radius: 50%; background: rgba(0, 255, 136, 0.1); border: 1px solid rgba(0, 255, 136, 0.3); color: #00FF88; display: flex; align-items: center; justify-content: center; font-size: 20px; margin: 0 auto 12px;">
                    <i class="fas fa-wallet"></i>
                </div>
                <h3 style="font-size: 14px; font-weight: 800; color: #FFF; margin-bottom: 6px;">WALLET ADDRESS REQUIRED</h3>
                <p style="font-size: 11px; color: #8C9BAE; max-width: 280px; margin: 0 auto 16px;">Please configure your BEP-20
                    USDT payout address in your profile to request working withdrawals.</p>
                <a href="{{ url('/User/EditProfile') }}" class="mecha-btn-cyan"
                    style="display: inline-flex; width: auto; padding: 0 20px; height: 38px;">
