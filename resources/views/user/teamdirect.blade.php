...
<div class="mecha-hud-card">
    ...
    <div class="cyber-toolbar-wrap">
        ...
        <div class="toolbar-search-box">
            ...
            <input type="text" id="memberSearchInput" class="toolbar-search-input" placeholder="Search by name, ID, date...">
        </div>
    </div>
    ...
    <div class="direct-cards-grid" id="cardsGridContainer">
        ...
        @forelse($direct as $row)
            ...
            <div class="member-cyber-card" 
                 data-search="{{ strtolower(($row->userid ?? '').' '.($row->name ?? '').' '.($row->doj ?? '').' '.($isActive ? 'active' : 'inactive').' '.($row->shares ?? '').' '.($row->teamtotal ?? '')) }}">
