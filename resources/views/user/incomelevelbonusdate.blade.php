...
@section('title', 'Team Development Breakdown - Cyera AI')
@section('page-title', 'Team Development Details')
@section('page-icon', 'fas fa-list-check')

@section('page-actions')
<a href="{{ url('/User/TeamDevelopmentReward') }}" class="mecha-btn-outline" style="padding: 4px 10px; font-size: 9px; height: auto;">
...
<div class="mecha-hud-card">
    <div class="mecha-card-header">
        <div class="mecha-card-title-wrap">
            ...
            <div>
                <h2 class="mecha-card-title">DEVELOPMENT REWARD BREAKDOWN</h2>
    ...
    <div class="mecha-table-wrap">
        <table id="teamDevDateTable" class="mecha-cyber-table" style="width:100%">
            <thead>
                <tr>
                    <th>#</th>
                    <th>FROM USER ID</th>
