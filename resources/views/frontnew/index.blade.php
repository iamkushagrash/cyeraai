      ...
      <div class="container">
        ...
        <div class="hero-title flex flex-col justify-center items-center">
          ...
          <div class="flex flex-col lg:flex-row gap-4 justify-center hero-btns">
            <a href="https://mwtscan.com/" target="_blank" class="btn btn-primary" data-title="Explore Cyera AI"><span>Explore Cyera AI</span> <i class="fa-solid fa-arrow-right"></i></a>
            <a href="https://console.cyera.ai/" target="_blank" class="btn" data-title="Meta Console"><span>Meta Console</span> </a>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="container">
            <div class="partners-swiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/101.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/102.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/103.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/104.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/105.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/106.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/107.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/108.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/109.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/110.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/111.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/112.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/113.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/114.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/115.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/116.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/117.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/118.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/119.svg')}}" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('front/assets/images/partners/120.svg')}}" alt=""></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="flex flex-col lg:flex-row lg:items-end justify-end mb-8 lg:mb-16">
          ...
          <div class="lg:w-[50%] lg:pl-8" data-anim="fade-up" data-delay="0.2">
            <p class="lead mb-4">Cyera AI empowers the future of digital wealth through decentralized infrastructure, transparent systems, and secure technologies, enabling users to grow, manage,
              and protect assets with confidence in a scalable, trust-driven ecosystem designed for long-term value creation.</p>
          </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row">
          <div class="feat lg:w-1/3" data-anim="fade-up">
            <img src="{{ asset('front/assets/images/shield.svg')}}" alt="">
          ...
          <div class="feat lg:w-1/3" data-anim="fade-up" data-delay="0.2">
            <img src="{{ asset('front/assets/images/cube.svg')}}" alt="">
          ...
          <div class="feat lg:w-1/3" data-anim="fade-up" data-delay="0.4">
            <img src="{{ asset('front/assets/images/growth.svg')}}" alt="">
        ...
        <div class="flex flex-col md:flex-row">
          <div class="feat lg:w-1/3" data-anim="fade-up" data-delay="0.1">
            <img src="{{ asset('front/assets/images/user.svg')}}" alt="">
          ...
          <div class="feat lg:w-1/3" data-anim="fade-up" data-delay="0.2">
            <img src="{{ asset('front/assets/images/chip.svg')}}" alt="">
            <h4 class="text-pri-gradient mb-3">Trust-First Ecosystem</h4>
          ...
          <div class="feat lg:w-1/3" data-anim="fade-up" data-delay="0.3">
            <img src="{{ asset('front/assets/images/server.svg')}}" alt="">
    ...
    <section class="features-home md:my-24 lg:my-28">
      <div class="container flex flex-col lg:flex-row items-start justify-between" data-anim="fade-up">
        <div class="lg:w-2/5 feat-intro">
          ...
          <img class="my-8" src="{{ asset('front/assets/images/image-feat.avif')}}" alt="">
          ...
          <img src="{{ asset('front/assets/images/arrow.avif')}}" class="w-full arrow-image hidden lg:block" alt="">
        </div>
        <div class="feat-cards lg:w-[55%] lg:pl-12 pt-12 lg:pt-0">
          <div class="feat-card">
            <div class="icon mb-4">
              <img src="{{ asset('front/assets/images/solvingcard.svg')}}" alt="">
            </div>
          ...
          <div class="feat-card">
            <div class="icon mb-4">
              <img src="{{ asset('front/assets/images/globe-shield.svg')}}" alt="">
            </div>
          ...
          <div class="feat-card">
            <div class="icon mb-4">
              <img src="{{ asset('front/assets/images/icon-storage.svg')}}" alt="">
            </div>
          ...
          <div class="feat-card">
            <div class="icon mb-4">
              <img src="{{ asset('front/assets/images/smart-contract.svg')}}" alt="">
            </div>
          ...
          <div class="feat-card">
            <div class="icon mb-4">
              <img src="{{ asset('front/assets/images/crolss-chain.svg')}}" alt="">
            </div>
          ...
          <div class="card development flex flex-col lg:flex-row items-center">
            <div class="card-content lg:w-1/2 order-2 lg:order-1">
              ...
              <p class="mb-6">Built to support businesses and communities with scalable infrastructure, intuitive tools, and secure systems that enable collaboration, growth, and long-term value
                creation across diverse Web3 use cases.</p>
    ...
    <section class="core-features bg-grad-primary my-20 lg:my-28">
        ...
        <div class="flex flex-col lg:flex-row items-end justify-end mb-16">
          ...
          <div class="lg:w-[55%] lg:pl-8 pt-4 lg:pt-0">
            <p class="mb-4" data-anim="fade-up" data-delay="0.6">M-Connect is the unified digital ecosystem of Cyera AI — a powerful hub that brings together all Meta decentralized applications in
              one seamless environment. Designed as a single entry point, M-Connect allows users to access, manage, and interact with the entire Meta ecosystem without friction, complexity, or
              multiple logins.</p>
      ...
      <div class="container">
        ...
        <div class="flex flex-col lg:flex-row">
          <div class="card lg:w-1/2" data-anim="fade-up" data-delay="0">
            <img src="{{ asset('front/assets/images/feat/wallet.avif')}}" alt="">
          ...
          <div class="card lg:w-1/2" data-anim="fade-up" data-delay="0.2">
            <img src="{{ asset('front/assets/images/feat/trading.avif')}}" alt="">
        ...
        <div class="flex flex-col lg:flex-row">
          <div class="card lg:w-2/6" data-anim="fade-up" data-delay="0">
            <img src="{{ asset('front/assets/images/feat/chat.avif')}}" alt="">
          ...
          <div class="card lg:w-2/6" data-anim="fade-up" data-delay="0.4">
            <img src="{{ asset('front/assets/images/feat/meet.avif')}}" alt="">
          ...
          <div class="card lg:w-2/6" data-anim="fade-up" data-delay="0.8">
            <img src="{{ asset('front/assets/images/feat/ai.avif')}}" alt="">
            <div class="sub-title mb-2">Cyera AI</div>
            <h4 class="mb-3 text-white-gradient">
        ...
        <div class="flex flex-col lg:flex-row">
          <div class="card lg:w-1/2" data-anim="fade-up" data-delay="0.2">
            <img src="{{ asset('front/assets/images/feat/play.avif')}}" alt="">
          ...
          <div class="card lg:w-1/2" data-anim="fade-up" data-delay="0.4">
            <img src="{{ asset('front/assets/images/feat/storage.avif')}}" alt="">
        ...
        <div class="flex flex-col lg:flex-row">
          <div class="card lg:w-2/6" data-anim="fade-up" data-delay="0.2">
            <img src="{{ asset('front/assets/images/feat/browser.avif')}}" alt="">
          ...
          <div class="card lg:w-2/6" data-anim="fade-up" data-delay="0.4">
            <img src="{{ asset('front/assets/images/feat/cloud.avif')}}" alt="">
          ...
          <div class="card lg:w-2/6" data-anim="fade-up" data-delay="0.6">
            <img src="{{ asset('front/assets/images/feat/mail.avif')}}" alt="">
      ...
      <div class="container pt-28" data-anim="fade-up" data-delay="0.2">
        <div class="coin-download flex flex-col lg:flex-row items-center justify-center">
          <div class="lg:w-1/2 relative flex flex-col items-center">
            <img src="{{ asset('front/assets/images/m-connet-1.avif')}}" alt="" class="relative z-20 mx-auto spin-bounce">
            <img src="{{ asset('front/assets/images/blurred-bg.avif')}}" alt="" class="bg-blur w-[60%] absolute z-10 blur-[100px] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          </div>
          <div class="lg:w-1/2">
            <div class="sub-title mb-2">M-Connect</div>
            <h2 class="mb-4">One Gateway. Infinite Meta Experiences</h2>
            <p class="mb-8">A unified access point connecting every Meta application, enabling seamless interaction, control, and growth across the ecosystem. </p>
        ...
        <div class="CAI-coins-swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="{{ asset('front/assets/images/CAI-coins/icon-1.avif')}}" alt="" class="mb-6">
            ...
            <div class="swiper-slide">
              <img src="{{ asset('front/assets/images/CAI-coins/icon-2.avif')}}" alt="" class="mb-6">
            ...
            <div class="swiper-slide">
              <img src="{{ asset('front/assets/images/CAI-coins/icon-3.avif')}}" alt="" class="mb-6">
            ...
            <div class="swiper-slide">
              <img src="{{ asset('front/assets/images/CAI-coins/icon-4.avif')}}" alt="" class="mb-6">
            ...
            <div class="swiper-slide">
              <img src="{{ asset('front/assets/images/CAI-coins/icon-6.avif')}}" alt="" class="mb-6">
            ...
            <div class="swiper-slide">
              <img src="{{ asset('front/assets/images/CAI-coins/icon-5.avif')}}" alt="" class="mb-6">
            ...
            <div class="card development flex flex-col lg:flex-row items-center">
              ...
              <div class="card-content lg:w-1/2">
                ...
                <p class="mb-6">MetaFX is the world's first decentralized foreign exchange trading platform, designed to enable transparent, borderless currency trading powered by blockchain
                  technology. It removes traditional intermediaries while offering users direct access to global FX markets through a secure and decentralized framework.</p>
                <ul class="check-list">
        ...
        <div class="testimonial-swiper" data-anim="fade-up" data-delay="0.2">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              ...
              <div class="user">
                <div class="user-pic">
                  <img src="{{ asset('front/assets/images/testimonials/153.webp')}}" alt="">
                </div>
                <div class="user-info">
            ...
            <div class="swiper-slide">
              ...
              <div class="user">
                <div class="user-pic">
                  <img src="{{ asset('front/assets/images/testimonials/148.webp')}}" alt="">
                </div>
                <div class="user-info">
            ...
            <div class="swiper-slide">
              <p class="quote">“Cyera AI provided exactly what our DAO community needed — transparent governance tools and reliable smart contract execution. It has simplified onboarding and
                boosted engagement.”</p>
              <div class="user">
                <div class="user-pic">
                  <img src="{{ asset('front/assets/images/testimonials/143.webp')}}" alt="">
                </div>
                <div class="user-info">
            ...
            <div class="swiper-slide">
              ...
              <div class="user">
                <div class="user-pic">
                  <img src="{{ asset('front/assets/images/testimonials/138.webp')}}" alt="">
                </div>
                <div class="user-info">
            ...
            <div class="swiper-slide">
              ...
              <div class="user">
                <div class="user-pic">
                  <img src="{{ asset('front/assets/images/testimonials/133.webp')}}" alt="">
                </div>
                <div class="user-info">
