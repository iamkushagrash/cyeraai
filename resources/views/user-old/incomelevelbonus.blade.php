...
<head>
	<meta charset="utf-8">
	<title>Team Development Reward</title>
...
@include('user.sidebaruser')
		...
		<div id="content" class="app-content">
			<ul class="breadcrumb">
				...
				<li class="breadcrumb-item active">Team Development Reward</li>
			</ul>
			
			<h1 class="page-header">
				Team Development Reward <!-- <br><small>Current Rank : </small> -->
			</h1>
										...
										<div class="card-body">
											<table id="datatableDefault" class="table text-nowrap w-100">
												...
												<tbody>
													...
													<tr>
														<td>{{$i}}</td>
														<!-- <td>{{round($referral->amount,3)}}</td> -->
														<td>{{round($referral->amountusdt,3)}}</td>
														<td>{{$referral->txndate}}</td>
                            <td><a href="/User/TeamDevelopmentReward/{{$referral->txndate}}" class="btn btn-outline-theme">View</a></td>
													</tr>
							            			<?php $i++; ?>
							            			@endforeach
												</tbody>
