...
<html lang="en" data-bs-theme="dark">
   <head>
      <meta charset="utf-8">
      <title>Winter Blast Bonanza Winners</title>
      ...
      <style>
         ...
         @keyframes glowTitle {
         0%,100% { text-shadow: 0 0 10px rgba(255,215,0,0.9); }
         ...
         width: 60%;
         height: 3px;
         background: linear-gradient(90deg, transparent, #ffda44, transparent);
         margin: 15px auto;
         box-shadow: 0 0 12px rgba(255,215,0,0.7);
         }
         /* ------------------ WINNER CARD (Premium Gold Edition) ------------------ */
         .winner-card {
         ...
         border-radius: 16px;
         padding: 2px;
         background: linear-gradient(135deg, #b8860b, #ffd700, #c9a236, #b8860b);
         -webkit-mask: 
         ...
         background-image: linear-gradient(white, white), linear-gradient(135deg, #ffd700, #b8860b);
         ...
         .winner-card:hover .winner-location {
         color: #ffe384;
         }
         /* Flag image */
         .flag-img, .winner-location img {
         width: 28px;
         height: 18px;
         margin-right: 6px;
         border-radius: 3px;
         ...
         .elite-title { font-size: 1.8rem !important; }
         .elite-subtitle { font-size: 1rem !important; }
         .elite-header { padding: 40px 15px 30px; }
         .winner-card { padding: 22px 18px; }
         .winner-name { font-size: 1.05rem; }
         }
      </style>
   </head>
   <body>
      ...
      <div id="content" class="app-content">
         ...
         <div class="container mb-4">
            <div class="row justify-content-center">
               <div class="col-md-6">
                  <input type="text" id="searchID" class="form-control form-control-lg text-center"
                     placeholder="Enter Your Winner ID (eg: CAI8596363)">
               </div>
            </div>
         </div>
         <div class="elite-header">
            <h1 class="elite-title">WINTER BLAST BONANZA WINNERS</h1>
            <div class="elite-underline"></div>
            <p class="elite-subtitle">Celebrating Our Top Performers & Their Luxurious Rewards</p>
         </div>
            ...
            <div class="container">
               <div class="row g-4">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6">
                     <div class="winner-card" data-id="{{ strtolower($item['ID']) }}">
                        <img src="{{ asset('main/assets/images/products/1.png') }}" class="winner-photo">
                        <div class="winner-name">{{ $item['name'] }}</div>
                        <div class="winner-name">{{ $item['ID'] }}</div>
                        <div class="winner-location">
                           <img src="https://flagcdn.com/24x18/{{ $item['flag_code'] }}.png">
                           {{ $item['country'] }}
                        </div>
                     </div>
                  </div>
