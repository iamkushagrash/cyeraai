...
@include('user.sidebaruser')
		...
		<div id="content" class="app-content">
			<ul class="breadcrumb">
				...
				<li class="breadcrumb-item active">Direct Reward</li>
			</ul>
			
			<h1 class="page-header">
				Direct Reward <!-- <br><small>Current Rank : </small> -->
			</h1>
									...
									<div class="card">
										<div class="card-body">
							              ...
							              <th>From ID</th>
												...
												<tbody>
													<?php $i=1; ?>
							            			@foreach($directamount as $directamount)
													<tr>
														<td>{{$i}}</td>
							              <td>{{$directamount->fromid}}</td>
							      				<td>{{$directamount->fromname}}</td>
														...
														<td><span style="color:#{{$directamount->statusclass}}">{{round($directamount->amountusdt,2)}}</span></td>
