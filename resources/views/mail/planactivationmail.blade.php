  ...
  <div class="template">
    ...
    <div class="second-content">
      <div class="content-name">
        <p>Dear {{$data['userid']}},</p>
      </div>
      <div class="below-para">
        <p>We are excited to inform you that your Staking with {{$data['amount']}} $ is now active. Now you can take advantage of Cyera AI and all its services</p>
