  ...
  <div class="template">
    ...
    <div class="second-content">
      ...
      <div class="below-para">
        <p>There is a request to change your password. Resetting your password is easy. Just press the button below and follow the instructions. We'll have you up and running in no time.</p>
        <!-- <p>Click below to reset your password:</p> -->
      </div>
    </div>
    <div class="table-container">
      <a href="{{url('/').'/password/reset/'.$data['token']}}"><button>Reset Password</button></a>
    </div>
