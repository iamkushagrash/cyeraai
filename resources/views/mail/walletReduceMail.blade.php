  ...
  <div class="template">
    ...
    <div class="second-content">
      ...
      <div class="below-para">
        <p>You just top-uped user {{$data['userid']}} with amount ${{$data['amount']}}.</p>
        <p>Your Wallet balance reduced by ${{$data['amount']}}. If you have not made this transaction, please contact our support team immediately.</p>
      </div>
    </div>
