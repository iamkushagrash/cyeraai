      ...
      <div class="container products">
        ...
        <div class="products-card flex flex-col lg:flex-row lg:gap-12 items-center justify-center">
          <div class="products-image">
            <img src="{{ asset('front2/assets/images/products/m-connect.avif')}}" class="w-[75%] mx-auto" alt="">
            <img class="blur-image" src="{{ asset('front2/assets/images/blurred-bg.avif')}}" alt="">
          </div>
          <div class="products-content">
            ...
            <p class="mb-4">M-Connect is the central access platform that brings all Meta applications into one seamless digital experience. It allows users to access, manage, and interact with
              multiple
              Meta services through a single login and a unified interface.</p>
        ...
        <div class="products-card flex flex-col lg:flex-row lg:gap-12 items-center justify-center">
          <div class="products-image">
            <img src="{{ asset('front2/assets/images/products/wallet.avif')}}" class="w-[75%] mx-auto" alt="">
            <img class="blur-image" src="{{ asset('front2/assets/images/blurred-bg.avif')}}" alt="">
          </div>
          <div class="products-content">
            ...
            <p class="mb-4">Users can send, receive, and manage assets seamlessly while maintaining complete control over their private keys. Meta Wallet integrates directly with all Meta
              applications,
              enabling secure authentication and frictionless transactions within M-Connect.</p>
        ...
        <div class="products-card flex flex-col lg:flex-row lg:gap-12 items-center justify-center">
          <div class="products-image">
            <img src="{{ asset('front2/assets/images/products/wealth.avif')}}" class="w-[75%] mx-auto" alt="">
            <img class="blur-image" src="{{ asset('front2/assets/images/blurred-bg.avif')}}" alt="">
          </div>
          <div class="products-content">
        ...
        <div class="products-card flex flex-col lg:flex-row lg:gap-12 items-center justify-center">
          <div class="products-image">
            <img src="{{ asset('front2/assets/images/products/meet.avif')}}" class="w-[75%] mx-auto" alt="">
            <img class="blur-image" src="{{ asset('front2/assets/images/blurred-bg.avif')}}" alt="">
          </div>
          <div class="products-content">
        ...
        <div class="products-card flex flex-col lg:flex-row lg:gap-12 items-center justify-center">
          <div class="products-image">
            <img src="{{ asset('front2/assets/images/products/storage.avif')}}" class="w-[75%] mx-auto" alt="">
            <img class="blur-image" src="{{ asset('front2/assets/images/blurred-bg.avif')}}" alt="">
          </div>
          <div class="products-content">
        ...
        <div class="products-card flex flex-col lg:flex-row lg:gap-12 items-center justify-center">
          ...
          <div class="products-content">
            ...
            <p class="mb-4">Meta Swap enables fast, transparent, and intermediary-free digital asset exchanges. Built on decentralized protocols, it allows users to swap assets directly from their
              wallets
              with full control and visibility.</p>
