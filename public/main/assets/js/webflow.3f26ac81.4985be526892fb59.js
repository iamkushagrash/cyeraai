( () => {
    var e = {
        84345: function(e, t, i) {
            ...
            r.define("slider", e.exports = function(e, t) {
                var i, s, d, l = {}, f = e.tram, c = e(document), u = r.env(), h = ".w-slider", v = "w-slider-force-show", p = a.triggers, m = !1;
                function b() {
                    (i = c.find(h)).length && (i.each(y),
                    d || (g(),
                    r.resize.on(x),
                    r.redraw.on(l.redraw)))
                }
                function g() {
                    r.resize.off(x),
                    r.redraw.off(l.redraw)
                }
                function x() {
                ...
                function O(t, i, r) {
                    return function(a) {
                        if (i)
                            t.hasFocus[r] = i;
                        else if (e.contains(t.el.get(0), a.relatedTarget) || (t.hasFocus[r] = i,
                        t.hasFocus.mouse && "keyboard" === r || t.hasFocus.keyboard && "mouse" === r))
                            return;
                        i ? (t.ariaLiveLabel.attr("aria-live", "polite"),
                        t.hasTimer && j(t)) : (t.ariaLiveLabel.attr("aria-live", "off"),
                        t.hasTimer && W(t))
                    }
                }
                function T(e, t) {
                ...
                function A(i) {
                    return function(a, o) {
                        ...
                        if ("swipe" === a.type)
                            return f.disableSwipe || r.env("editor") ? void 0 : "left" === o.direction ? E(i)() : "right" === o.direction ? R(i)() : void 0;
                ...
                function _(t, i) {
                    ...
                    var n = i.index
                      , d = {};
                    n < 0 ? (n = a.length - 1,
                    r.infinite && (d.x = -t.endX,
                    d.from = 0,
                    d.to = a[0].width)) : n >= a.length && (n = 0,
                    r.infinite && (d.x = a[a.length - 1].width,
                    ...
                    r.hideArrows && (t.index === a.length - 1 ? t.right.hide() : t.right.show(),
                    ...
                    if (t.index !== t.previous) {
                        if (s || t.ariaLiveLabel.text(`Slide ${n + 1} of ${a.length}.`),
                        "cross" === x) {
                ...
                function P(t) {
                    ...
                    function(t) {
                        var i, r = [], a = t.el.attr("data-nav-spacing");
                        a && (a = parseFloat(a) + "px");
                        for (var n = 0, o = t.pages; n < o; n++)
                            (i = e('<div class="w-slider-dot" data-wf-ignore />')).attr("aria-label", "Show slide " + (n + 1) + " of " + o).attr("aria-pressed", "false").attr("role", "button").attr("tabindex", "-1"),
        ...
        i.O = (t, r, a, n) => {
            ...
            for (var s = 1 / 0, o = 0; o < e.length; o++) {
                for (var [r,a,n] = e[o], d = !0, l = 0; l < r.length; l++)
                    (!1 & n || s >= n) && Object.keys(i.O).every(e => i.O[e](r[l])) ? r.splice(l--, 1) : (d = !1,
                    n < s && (s = n));
                if (d) {
                    e.splice(o--, 1);
                    var f = a();
    ...
    var r = i.O(void 0, ["365", "273"], function() {
        return i(49166)
    });
    r = i.O(r)
}
